...
exports.run = (client, message, args) => {
    ...
    var cmds = ['`ping` - Показывает ваш пинг', '`poll` - Проводит голосование', '`serverinfo` - Показывает информацию о сервере', '`about` - Показывает информацию о боте', '`report` - Пожаловаться на участника', '`open-case`- Открыть донат кейс', '`userinfo`- Получить информацию о участнике']
