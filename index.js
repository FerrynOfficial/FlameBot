...
fs.readdir('./cmds/', (err, files) => {
    ...
    jsfiles.forEach(f => {
     ...
     client.on('guildMemberAdd', member =>{
        ...
        .setDescription('Приветствуем, вас ${member.displayName}, на сервере TheGamers™!  Мы очень рады увидеть вас и надеемся, что наша компания покажется, вам, интересной. В случае проблем и вопросов обращайтесь к Администрации сервера. С уважением TheFerryn')
        .setColor('RANDOM')
        channel.send(embed)
    })
})
