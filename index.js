...
client.on('guildMemberAdd', member =>{
        ...
        .setDescription(`Приветствуем вас ${member}, на сервере FlameCommunity 2.0!  Мы очень рады увидеть вас и надеемся, что наша компания покажется, вам, интересной. В случае проблем и вопросов обращайтесь к Администрации сервера.А также, у нас проходит раздача ролей в #❄╰🎉╮раздачи.Успей получить эксклюзивную роль!С уважением TheFerryn`)
        .setColor('RANDOM')
